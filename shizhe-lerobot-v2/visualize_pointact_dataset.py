...
class Args(Tap):
    ...
    ee_state_key: str = "observation.states.ee_state"
    joint_state_key: str = "observation.states.joint_state"
    gripper_state_key: str = "observation.states.gripper_state"
    point_cloud_key: str = "observation.points.frontview"
    image_key: str = "observation.images.front_image"

    show_joint_info: bool = False
    trajectory_subsample: int = 3
