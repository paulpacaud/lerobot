# Coding style
- When you you need to use a parser, favor typed-argument-parser to define a clean arguments class at the top of the script, it is cleaner.
- Constants must be in capital letters

# Reply style
- When you reply and show an example python usage command, give it inline without line breaks
