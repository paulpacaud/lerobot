...
python -m examples.post_process_dataset.run_full_pipeline --input_dir="${SCRATCH}/data/lerobot/${INPUT_DATASET}" --output_dir="${SCRATCH}/data/lerobot/${INPUT_DATASET}_pointact" --num_workers=10